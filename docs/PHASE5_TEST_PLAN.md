...
Deploying Studio or Admin must not require redeploying Public Web unless the Public Web runtime itself changes. The API's `PUBLIC_WEB_RUNTIME_VERSION` must equal the actually deployed Web runtime contract (`1.0.0` for this handoff).
